...
class MetodoAbcdeActivity : AppCompatActivity() {
    ...
    private fun iniciarComponentes() {
        ...
        txtAreaAbcde =
            findViewById(R.id.txtAreaAbcde)

        txtResumoAbcde =
            findViewById(R.id.txtResumoAbcde)

        txtResultadoAbcde =
            findViewById(R.id.txtResultadoAbcde)

        btnRelatorioAbcde =
            findViewById(R.id.btnRelatorioAbcde)

        btnVoltarAbcde =
            findViewById(R.id.btnVoltarAbcde)
    }
