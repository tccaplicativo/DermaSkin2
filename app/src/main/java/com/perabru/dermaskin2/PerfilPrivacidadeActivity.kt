...
class PerfilPrivacidadeActivity : AppCompatActivity() {
    ...
    private lateinit var btnEditarPerfilSaude: LinearLayout

    private lateinit var btnExcluirDados: LinearLayout
    private lateinit var btnSairContaPrivacidade: LinearLayout
    private lateinit var btnVoltarPrivacidade: ImageButton

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(
            R.layout.activity_perfil_privacidade
        )
    ...
    private fun iniciarComponentes() {
        ...
        txtStatusPerfilSaude =
            findViewById(
                R.id.txtStatusPerfilSaude
            )

        btnEditarPerfilSaude =
            findViewById(
                R.id.btnEditarPerfilSaude
            )


        btnExcluirDados =
            findViewById(
                R.id.btnExcluirDados
            )

        btnSairContaPrivacidade =
            findViewById(
                R.id.btnSairContaPrivacidade
            )

        btnVoltarPrivacidade =
            findViewById(
                R.id.btnVoltarPrivacidade
            )
    }
    ...
    private fun configurarTela() {
        ...
        txtEmailUsuario.text =
            "E-mail da conta: ${usuario?.email ?: "Não informado"}"
